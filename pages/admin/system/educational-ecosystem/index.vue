                    ...
                    <div>
                        ...
                        <div class="card-educational-ecosystem">
                            <div class="card-educational-ecosystem-body">
                                ...
                                <div>
                                    <div class="mb-3 btn-educational-ecosystem-delete" v-b-tooltip.hover title="Xoá ảnh">
                                    ...
                                    <div class="btn-educational-ecosystem-save" v-b-tooltip.hover title="Tải ảnh lên">
                                        <svg width="33" height="32" viewBox="0 0 33 32" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="16.5" cy="16" r="16" fill="#F2F2F2" />
