                ...
                <v-col class="mt-0 pt-0" xs="12" sm="12" md="12" lg="7" xl="7">
                    <div class="card-role mb-4">
                        <div class="card-role-body">
                            ...
                            <div>
                                <div class="blade-role mb-2">admin</div>
                                <div class="user-name mb-2">Lê Văn B</div>
                    ...
                    <div class="roles-group-input">
                        ...
                        <div>
                            <input type="text" class="form-control roles-input" placeholder="Nhập tên tài khoản" />
                        </div>
                    </div>
                    ...
                    <div class="roles-group-input">
                        ...
                        <div>
                            <input type="text" class="form-control roles-input" placeholder="Nhập số điện thoại" />
                        </div>
                    </div>
                    ...
                    <div class="roles-group-input">
                        ...
                        <div>
                            <input type="password" class="form-control roles-input" placeholder="Nhập mật khẩu" />
                        </div>
                    </div>
                    ...
                    <div class="roles-group-input">
                        ...
                        <p class="note-role">* Quản trị viên Admin có quyền cao nhất, có thể sử dụng tất cả các chức năng
                    ...
                    <div class="pt-5">
                        <button-component addClass="silver">
                            <svg class="me-2" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
