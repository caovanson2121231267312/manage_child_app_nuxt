    ...
    <div class="content-mp">
        <div class="admins">
            <div class="admins-group-btn mb-2 flex-bet">
                <div class="btn btn-admins-primary">
                ...
                <div class="btn btn-roles-primary">
            ...
            <v-row>
                ...
                <v-col class="mt-0 pt-0" v-for="n in 15" :key="n" xs="12" sm="6" md="4" lg="4" xl="3">
                    <b-card style="min-width: 245px;" class="hover-card">
                        <nuxt-link class="block w-100 card-admins" to="/admin/users/parent/34">
                            ...
                            <div class="action">
                                <div class="action-btn"  v-b-tooltip.hover.right="'Sửa'" title="Sửa">
                                ...
                                <div class="action-btn"  v-b-tooltip.hover.right="'Xoá'" title="Xoá">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="15" cy="15" r="15" fill="#F2F2F2" />
