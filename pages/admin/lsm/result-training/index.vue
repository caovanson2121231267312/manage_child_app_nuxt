                        ...
                        <div class="mb-7 ">
                            <div class="d-flex align-items-center flex-wrap">
                                <nuxt-link to="/admin/lsm/teacher-training">
                                    <button-filter>Quản lý chương trình</button-filter>
                                </nuxt-link>
                                <nuxt-link to="/admin/lsm/result-training">
                                    <button-filter active="active">Quản lý kết quả đào tạo</button-filter>
                                </nuxt-link>
                            </div>
                        </div>
                ...
                <v-row>
                    <v-col cols="12" xs="12">
                        <div class="d-flex justify-content-between align-items-center">
                            <label class="chart-title">Lọc theo</label>
                            <div>
