        ...
        <v-row>
            <v-col class="mt-0 pt-0" xs="12" sm="12" md="6" lg="6" xl="6" style="min-width: 373px;">
                <div class="d-flex align-items-center justify-content-between wmt-27">
                    ...
                    <nuxt-link to="/admin/lsm/teacher-training/3/edit" class="btn-edit">
                    ...
                    <div>
                        <nuxt-link v-for="n in 6" v-bind:key="n"
                            ...
                            <div class="">
                                ...
                                <span class="lesson mt-2">Bài {{ n }}: Giới thiệu {{ n * 5 }}</span>
                            </div>
                            <div>
                ...
                <div>
                    ...
                    <div class="my-7">
                        <nuxt-link to="/admin/lsm/teacher-training/3/teachers">
                            <button-add>
