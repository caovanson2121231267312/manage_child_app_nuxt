<template>
    <div class="content-mp detail-form-review form-edit-train">
        <v-row>
                ...
                <div class="w-100">
                    <div class="mt-3">
                        ...
                        <div class="input-grop">
                            <input type="text" class="input" value="Bảo mẫu cơ bản 0 - 6 tuổi" />
                        </div>
                    </div>
                    <div class="mt-3">
                        <strong class="strong-title">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-grop">
                            <select class="select">
                                <option>Tất cả User Giáo viên</option>
                                <option>Tất cả tài khoản User Giáo viên đã kích hoạt</option>
                                <option>User Giáo viên cụ thể</option>
                            </select>
                            <span class="icon-down mdi mdi-chevron-down"></span>
                        </div>
                    </div>
...
export default {
    ...
    mounted() {
        this.title.previous = '/admin/teacher-training/' + (this.id ?? 0)
