        ...
        <v-row>
            <v-col class="mt-0 pt-0" xs="12" sm="6" md="4" lg="4" xl="3">
                <b-card style="min-width: 245px;" class="">
                    <nuxt-link class="block w-100 teachers teacher-detail" to="/admin/complain/12">
                        <div class="w-100">
                            <table class="w-100">
                                <tbody>
                                    <tr>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <div class="" style="max-width: 115px">
                                                            <span class="name">Nguyễn Thị Anh
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="w-100 p-text">
                                                {{ this.shortenedText("Tôi có thắc mắc về một số phương pháp dạy và giáo trình đi kèm của dịch vụ Bảo mẫu Pro", 50) }}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="w-100">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="w-100 p-text">
                                                {{ shortenedText("Tôi có thắc mắc về một số phương pháp dạy và giáo trình đi kèm của dịch vụ Bảo mẫu Pro", 50) }}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
